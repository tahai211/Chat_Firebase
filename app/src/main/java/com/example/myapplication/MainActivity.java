...
import com.example.myapplication.messager.MessagesAdapter;
import com.example.myapplication.messager.MessagesList;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.child("users").getChildren()){
                    ...
                    if (!getMobile.equals(mobile)) {
                        ...
                        final String getPrifilePic = dataSnapshot.child("profile_pic").getValue(String.class);
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (getChatCounts > 0){
                                    ...
                                    for (DataSnapshot dataSnapshot1 : snapshot.getChildren()){
                                        ...
                                        if (dataSnapshot1.hasChild("user_1") && dataSnapshot1.hasChild("user_1") && dataSnapshot1.hasChild("messages")){
                                ...
                                if (!dataSet){
                                    dataSet = true;
                                    MessagesList messagesList = new MessagesList(getName,getMobile,lastMessage,getPrifilePic,unseenMessages,chatKey);
